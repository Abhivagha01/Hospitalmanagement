...
import './Index.css';
import Updatedocter from './Hospital Management/Updatedocter';
import UpdatePatients from './Hospital Management/UpdatePatients';
...
const App = () => {
    ...
    return (
        <>
            <Routes>
                {/* <Route path="/" element={localStorage.getItem('islogin')?(<Mainpage />):(<Signin/>)}></Route> */}
                <Route path='/' element={<Signin />} />
                <Route path="/" element={localStorage.getItem('islogin')?(<Index />):(<Signin/>)}></Route>
                ...
                <Route path='/updatedocter/:id' element={< Updatedocter />} />
