                                    ...
                                    <div className="tab-pane body active" id="Followers">
                                        <ul className="right_chat list-unstyled">
                                            ...
                                            <li className="offline">
                                                <a href="javascript:void(0);">
                                                    <div className="media">
                                                        <img className="media-object " src="hospital management Admin/assets/images/xs/avatar1.jpg" alt="" />
                                                        <div className="media-body">
                                    ...
                                    <div className="tab-pane body" id="friends">
                                        <ul className="new_friend_list list-unstyled row">
                                            <li className="col-lg-4 col-md-2 col-sm-6 col-4">
                                                <a href="#">
                                                    <img src="hospital management Admin/assets/images/sm/avatar1.jpg" className="img-thumbnail" alt="User Image" />
                                            ...
                                            <li className="col-lg-4 col-md-2 col-sm-6 col-4">
                                                <a href="#">
                                                    <img src="hospital management Admin/assets/images/sm/avatar2.jpg" className="img-thumbnail" alt="User Image" />
                                            ...
                                            <li className="col-lg-4 col-md-2 col-sm-6 col-4">
                                                <a href="#">
                                                    <img src="hospital management Admin/assets/images/sm/avatar3.jpg" className="img-thumbnail" alt="User Image" />
                                            ...
                                            <li className="col-lg-4 col-md-2 col-sm-6 col-4">
                                                <a href="#">
                                                    <img src="hospital management Admin/assets/images/sm/avatar4.jpg" className="img-thumbnail" alt="User Image" />
                                            ...
                                            <li className="col-lg-4 col-md-2 col-sm-6 col-4">
                                                <a href="#">
                                                    <img src="hospital management Admin/assets/images/sm/avatar5.jpg" className="img-thumbnail" alt="User Image" />
                                ...
                                <div className="body user_activity">
                                    <div className="streamline b-accent">
                                        <div className="sl-item">
                                            <img className="user rounded-circle" src="hospital management Admin/assets/images/xs/avatar4.jpg" alt="" />
                                        ...
                                        <div className="sl-item">
                                            <img className="user rounded-circle" src="hospital management Admin/assets/images/xs/avatar5.jpg" alt="" />
                                            <div className="sl-content">
                                        ...
                                        <div className="sl-item">
                                            <img className="user rounded-circle" src="hospital management Admin/assets/images/xs/avatar6.jpg" alt="" />
                                            <div className="sl-content">
                                        ...
                                        <div className="sl-item">
                                            <img className="user rounded-circle" src="hospital management Admin/assets/images/xs/avatar7.jpg" alt="" />
                                            <div className="sl-content">
                                                <h5 className="m-b-0">General Surgery</h5>
