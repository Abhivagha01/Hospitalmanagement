                ...
                <form className="form" method action="#">
                  <div className="header">
                    <div className="logo-container">
                      <img className="rounded-circle img-raised" src="hospital management Admin/assets/images/profile_av.jpg" alt="" />
                    </div>
                    <h5>Michael</h5>
                    <span>Locked</span>
                  </div>
                  ...
                  <div className="footer text-center">
                    <Link to="/dashboard" className="btn btn-primary btn-round btn-block  waves-effect waves-light">LOG IN</Link>
