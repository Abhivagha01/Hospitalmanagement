...
const Index = () => {
    ...
    return (
        <div>
            ...
            {/* <!-- start hero --> */}
            <section id="hero">
                <div class="slider" style={{ backgroundImage: 'url(assets/images/slider1.jpg)' }}>
                    <div class="container">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            }
                            {
                                (showContent == true) ?
                                    ("") :
                                    (<div className='m-auto'><button onClick={toggleContent} className='btn btn-simple btn-primary btn-round'>View More</button></div>)
                            }
                                            ...
                                            <div class="col-lg-3 col-md-6 col-sm-12">
                                                <div class="team-box text-center" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="5000">
                                                    ...
                                                    <div class="doctor-info">
                                                        <h4>{result.name}<span>{result.specialist}</span></h4>
                                                        <ul class="clearfix">
                                                            <li><a href="javascript:void(0);"><i class="zmdi zmdi-facebook"></i></a></li>
                                                            <li><a href="javascript:void(0);"><i class="zmdi zmdi-twitter"></i></a></li>
                                                            <li><a href="javascript:void(0);"><i class="zmdi zmdi-instagram"></i></a></li>
                                                        </ul>
                                                        <button type="button" onClick={Editdocter} data-id={result.id} className="btn btn-simple btn-primary btn-round" href="javascript:void(0);">View More</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </>
